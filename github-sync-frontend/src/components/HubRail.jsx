...
const PINNED_HUBS = [
  ...
  { path: '/supermarket', label: 'Supermarket', color: 'bg-hub-supermarket' },
...
const MORE_HUBS = [
  ...
  { path: '/panteka-market', label: 'Panteka Market', color: 'bg-hub-panteka' },
  { path: '/kids-and-baby', label: 'Kids & Baby', color: 'bg-hub-kidsbaby' },
  { path: '/interior-decor', label: 'Furniture, Curtain & Bedding', color: 'bg-hub-interiordecor' },
]
