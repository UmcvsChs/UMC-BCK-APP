drop function public.checkout_cart(uuid, text, uuid, numeric, boolean, numeric);
drop function public.place_order(uuid, jsonb, text, uuid, numeric, boolean, numeric);
...
create function public.place_order(
  ...
  p_delivery_type public.delivery_type default 'home_delivery',
...
create function public.checkout_cart(
  ...
  p_delivery_type public.delivery_type default 'home_delivery', p_terms_accepted boolean default false
) returns uuid
language plpgsql security definer set search_path = public
as $$
...
begin
  ...
  v_order_id := public.place_order(p_seller_id, v_items, p_delivery_address, p_delivery_lga_id, p_delivery_fee, p_is_instalment, p_deposit_amount, p_delivery_type, p_terms_accepted);
...
revoke execute on function public.place_order(uuid, jsonb, text, uuid, numeric, boolean, numeric, public.delivery_type, boolean) from public, anon;
revoke execute on function public.checkout_cart(uuid, text, uuid, numeric, boolean, numeric, public.delivery_type, boolean) from public, anon;
